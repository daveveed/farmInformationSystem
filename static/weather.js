const timeEl = document.getElementById('time');
        ...
        function getWeatherData () {
            ...
            fetch('/get-shapefile-midpoint/' + farm_id) // Replace with your Django endpoint
            .then(res => res.json())
            .then(midpoint => {
            console.log("Shapefile midpoint:", midpoint);

            // Call OpenWeather API with the retrieved midpoint coordinates
            fetchWeatherData(midpoint.lat, midpoint.lon);
            });
        }
